...
from ocs2_anymal_croc import mpc_interface
from ocs2_anymal_croc import scalar_array, state_vector_array, state_matrix_array, input_vector_array, dynamic_vector_array, cost_desired_trajectories

class anymal_croc_python_tests(unittest.TestCase):
