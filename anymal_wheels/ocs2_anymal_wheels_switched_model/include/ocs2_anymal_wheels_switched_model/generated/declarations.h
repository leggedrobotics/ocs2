...
static const LinkIdentifiers orderedLinkIDs[linksCount] =
    {BASE,LF_HIP,LF_THIGH,LF_SHANK_FIXED,LF_WHEEL_L,RF_HIP,RF_THIGH,RF_SHANK_FIXED,RF_WHEEL_L,LH_HIP,LH_THIGH,LH_SHANK_FIXED,LH_WHEEL_L,RH_HIP,RH_THIGH,RH_SHANK_FIXED,RH_WHEEL_L};
