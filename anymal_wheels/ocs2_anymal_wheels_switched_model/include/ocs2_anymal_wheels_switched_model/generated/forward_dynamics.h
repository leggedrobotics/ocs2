...
public:
    ...
    typedef iit::ANYmal::tpl::MotionTransforms<TRAIT> MTransforms;
...
private:
    ...
    Velocity LF_WHEEL_L_c;
    Force    LF_WHEEL_L_p;

    Column6DS LF_WHEEL_L_U;
    Scalar LF_WHEEL_L_D;
    Scalar LF_WHEEL_L_u;
    // Link 'RF_HIP' :
    Matrix66S RF_HIP_AI;
    ...
    Velocity RF_WHEEL_L_c;
    Force    RF_WHEEL_L_p;

    Column6DS RF_WHEEL_L_U;
    Scalar RF_WHEEL_L_D;
    Scalar RF_WHEEL_L_u;
    // Link 'LH_HIP' :
    Matrix66S LH_HIP_AI;
    ...
    Velocity LH_WHEEL_L_c;
    Force    LH_WHEEL_L_p;

    Column6DS LH_WHEEL_L_U;
    Scalar LH_WHEEL_L_D;
    Scalar LH_WHEEL_L_u;
    // Link 'RH_HIP' :
    Matrix66S RH_HIP_AI;
    ...
    Velocity RH_WHEEL_L_c;
    Force    RH_WHEEL_L_p;

    Column6DS RH_WHEEL_L_U;
    Scalar RH_WHEEL_L_D;
    Scalar RH_WHEEL_L_u;
private:
