...
class JSIM : public iit::rbd::StateDependentMatrix<iit::ANYmal::tpl::JointState<typename TRAIT::Scalar>, 22, 22, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::ANYmal::tpl::JointState<typename TRAIT::Scalar>, 22, 22, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::ANYmal::tpl::JointState<Scalar> JointState;
        ...
        typedef const Eigen::Block<const MatrixType,6,16> BlockF_t;
        ...
        typedef iit::ANYmal::tpl::ForceTransforms<TRAIT> FTransforms;
    ...
    public:
         ...
         * \return the 6x16 upper right block of this JSIM
         */
         ...
         * \return the 16x16 lower right block of this JSIM,
