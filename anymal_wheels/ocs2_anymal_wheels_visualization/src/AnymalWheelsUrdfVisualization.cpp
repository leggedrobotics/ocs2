...
int main(int argc, char* argv[]) {
  ros::init(argc, argv, "ocs2_anymal_wheels_visualization_visualizer");
  ros::NodeHandle nh;

  const std::string joint_topic = "xpp/joint_anymal_wheels_des";
  std::string urdf_param = "ocs2_anymal_wheels_description";
  ...
  // urdf joint names
  int n_ee = 4;
  int n_j = 4;  // degrees of freedom per leg
