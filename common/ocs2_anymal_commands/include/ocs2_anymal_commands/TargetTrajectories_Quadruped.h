/*
 * TargetTrajectories_Quadruped.h
 *
...
#pragma once
#ifndef TARGETTRAJECTORIES_QUADRUPED_H_
#define TARGETTRAJECTORIES_QUADRUPED_H_

#include <iomanip>
#include <mutex>

#include <ocs2_robotic_tools/command/TargetTrajectories_Interface.h>
...
class TargetTrajectories_Quadruped : public ocs2::TargetTrajectories_Keyboard_Interface<SCALAR_T> {
 public:
  ...
  using BASE = ocs2::TargetTrajectories_Interface<SCALAR_T>;
   ...
   */
  TargetTrajectories_Quadruped(int argc, char* argv[], const std::string& robotName, scalar_t initZHeight,
    ...
    observationSubscriber_ = this->nodeHandle_->subscribe("/" + robotName + "_mpc_observation", 1,
                                                          &TargetTrajectories_Quadruped::observationCallback, this);
  }

  /**
   * Default destructor
   */
  ~TargetTrajectories_Quadruped() = default;
