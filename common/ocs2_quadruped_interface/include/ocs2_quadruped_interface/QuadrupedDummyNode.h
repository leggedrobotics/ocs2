...
void quadrupedDummyNode(ros::NodeHandle& nodeHandle, const QuadInterface& quadrupedInterface,
                        const typename QuadInterface::rollout_base_t* rolloutPtr, double mrtDesiredFrequency, double mpcDesiredFrequency) {
