...
namespace switched_model
{
                                                       ...
                                                       const ocs2::MultipleShootingSolverSettings &sqpSettings)
  {
    ...
    {
      auto mpcPtr = std::unique_ptr<ocs2::MultipleShootingMpc>(new ocs2::MultipleShootingMpc(mpcSettings, sqpSettings, &quadrupedInterface.getDynamics(),
                                                                                             &quadrupedInterface.getCost(), quadrupedInterface.getConstraintPtr()));
