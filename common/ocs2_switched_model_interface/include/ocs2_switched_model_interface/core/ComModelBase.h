...
class ComModelBase {
 public:
   ...
   */
  virtual Eigen::Matrix<SCALAR_T, 6, JOINT_COORD_SIZE> comJacobainBaseFrame(const joint_coordinate_t& jointCoordinate);
   ...
   */
  virtual vector3d_t comPositionBaseFrame(const joint_coordinate_t& q) = 0;
   ...
   * @return
   */
  virtual Eigen::Matrix<SCALAR_T, 6, 6> comInertia(const Eigen::Matrix<SCALAR_T, 12, 1>& q) = 0;
   ...
   * @return
   */
  virtual Eigen::Matrix<SCALAR_T, 4, 4> comHomogeneous(const Eigen::Matrix<SCALAR_T, 12, 1>& q) = 0;
   ...
   * @return
   */
  virtual Eigen::Matrix<SCALAR_T, 6, 6> comInertiaDerivative(const Eigen::Matrix<SCALAR_T, 12, 1>& q,
   ...
   * @return
   */
  virtual Eigen::Matrix<SCALAR_T, 6, 12> comMomentumJacobian(const Eigen::Matrix<SCALAR_T, 12, 1>& q) = 0;
   ...
   * @return
   */
  virtual Eigen::Matrix<SCALAR_T, 6, 12> comMomentumJacobianDerivative(const Eigen::Matrix<SCALAR_T, 12, 1>& q,
                                                                       const Eigen::Matrix<SCALAR_T, 12, 1>& dq) = 0;
   ...
   * @return
   */
  virtual Eigen::Matrix<SCALAR_T, 3, 1> comVelocityInBaseFrame(const Eigen::Matrix<SCALAR_T, 12, 1>& q,
                                                               const Eigen::Matrix<SCALAR_T, 12, 1>& dq) = 0;
   ...
   * @param [out] basePose
   */
  virtual void calculateBasePose(const joint_coordinate_t& qJoints, const base_coordinate_t& comPose, base_coordinate_t& basePose);
   ...
   * (6-states)
   */
  void calculateBaseLocalVelocities(const joint_coordinate_t& qJoints, const joint_coordinate_t& dqJoints,
                                    const base_coordinate_t& comLocalVelocities, base_coordinate_t& baseLocalVelocities);
};
