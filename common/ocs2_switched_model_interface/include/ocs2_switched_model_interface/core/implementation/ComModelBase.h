...
Eigen::Matrix<SCALAR_T, 6, JOINT_COORD_SIZE> ComModelBase<JOINT_COORD_SIZE, SCALAR_T>::comJacobainBaseFrame(
  ...
  I_inverse << rotationMInverse, matrix3d_t::Zero(), matrix3d_t::Zero(), (1 / I(5, 5)) * matrix3d_t::Identity();
...
/******************************************************************************************************/
template <size_t JOINT_COORD_SIZE, typename SCALAR_T>
void ComModelBase<JOINT_COORD_SIZE, SCALAR_T>::calculateBasePose(const joint_coordinate_t& qJoints, const base_coordinate_t& comPose,
...
/******************************************************************************************************/
template <size_t JOINT_COORD_SIZE, typename SCALAR_T>
void ComModelBase<JOINT_COORD_SIZE, SCALAR_T>::calculateBaseLocalVelocities(const joint_coordinate_t& qJoints,
