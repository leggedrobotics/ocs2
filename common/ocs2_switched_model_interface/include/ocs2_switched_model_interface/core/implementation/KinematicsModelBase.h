...
void KinematicsModelBase<SCALAR_T>::update(const Eigen::DenseBase<BASE_COORDINATE>& qBase,
...
/******************************************************************************************************/
template <typename SCALAR_T>
void KinematicsModelBase<SCALAR_T>::feetPositionsBaseFrame(std::array<vector3d_t, 4>& feetPositions) {
...
/******************************************************************************************************/
template <typename SCALAR_T>
void KinematicsModelBase<SCALAR_T>::footPositionOriginFrame(const size_t& footIndex, vector3d_t& footPosition) {
...
/******************************************************************************************************/
template <typename SCALAR_T>
void KinematicsModelBase<SCALAR_T>::footPositionOriginFrame(const generalized_coordinate_t& generalizedCoordinate,
...
/******************************************************************************************************/
template <typename SCALAR_T>
void KinematicsModelBase<SCALAR_T>::feetPositionsOriginFrame(std::array<vector3d_t, 4>& feetPositions) {
...
/******************************************************************************************************/
template <typename SCALAR_T>
void KinematicsModelBase<SCALAR_T>::feetPositionsOriginFrame(const generalized_coordinate_t& generalizedCoordinate,
...
/******************************************************************************************************/
template <typename SCALAR_T>
void KinematicsModelBase<SCALAR_T>::FromBaseJacobianToInertiaJacobian(
    const matrix3d_t& i_R_b, const vector3d_t& b_r_point, const Eigen::Matrix<SCALAR_T, 6, JOINT_COORDINATE_SIZE>& b_J_point,
    Eigen::Matrix<SCALAR_T, 6, JOINT_COORDINATE_SIZE + 6>& i_J_point) {
  // rotation
...
/******************************************************************************************************/
template <typename SCALAR_T>
void KinematicsModelBase<SCALAR_T>::FromBaseVelocityToInertiaVelocity(const matrix3d_t& i_R_b,
