...
#include "ocs2_switched_model_interface/foot_planner/cpg/FootCPG.h"
...
class Feet3DPlanner : public FeetPlannerBase<scalar_t, FootCPG<scalar_t>> {
 public:
   ...
   * default constructor
   */
  Feet3DPlanner() : Feet3DPlanner(0.15, 1.0) {}
   ...
   */
  void setFootholdsPlan(const scalar_array_t& touchdownTimeStock, const std::vector<vector_3d_array_t>& touchdownPosStock,
