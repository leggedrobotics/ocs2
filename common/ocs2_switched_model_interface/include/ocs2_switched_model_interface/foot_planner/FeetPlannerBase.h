...
class FeetPlannerBase {
 public:
   ...
   */
  virtual void planSingleMode(const size_t& index, const size_array_t& phaseIDsStock, const scalar_array_t& eventTimes,
 ...
 protected:
   ...
   */
  void updateFootSchedule(const size_t& footIndex, const size_array_t& phaseIDsStock, const bool_array_t& contactFlagStock,
                          int_array_t& startTimeIndexStock, int_array_t& finalTimeIndexStock) const;
   ...
   */
  void extractContactFlags(const size_array_t& phaseIDsStock, std::array<bool_array_t, 4>& contactFlagStock) const;
   ...
   */
  void findIndex(const size_t& index, const bool_array_t& contactFlagStock, int& startTimesIndex, int& finalTimesIndex) const;
