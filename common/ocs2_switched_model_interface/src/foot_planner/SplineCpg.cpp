...
SplineCpg::SplineCpg(CubicSpline::Node liftOff, scalar_t midHeight, CubicSpline::Node touchDown)
    : leftSpline_(liftOff, CubicSpline::Node{(liftOff.time + touchDown.time) / 2, midHeight, 0.0}),
      rightSpline_(CubicSpline::Node{(liftOff.time + touchDown.time) / 2, midHeight, 0.0}, touchDown) {}
