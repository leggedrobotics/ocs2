...
TEST(TestFootplacementCost, constraintConversion) {
  ...
  const auto emptyConstraints = tangentialConstraintsFromConvexTerrain(convexTerrain);
  ...
  const auto linConstraints = tangentialConstraintsFromConvexTerrain(convexTerrain);
