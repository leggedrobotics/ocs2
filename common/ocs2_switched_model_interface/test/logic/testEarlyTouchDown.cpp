...
TEST(testEarlyTouchDown, testTrot) {
  ...
  gaitSchedule.setGaitAfterTime(gait, gaitSchedule.getCurrentTime() + gait.duration);
  ...
  earlyTouchDownGaitAdaptor = earlyTouchDownAdaptation(earlyTouchDownPerLeg);
  gaitSchedule.adaptCurrentGait(earlyTouchDownGaitAdaptor);
...
TEST(testEarlyTouchDown, testOverhangingSwingPhases) {
  ...
  gaitSchedule.setGaitAfterTime(nextGait, gaitSchedule.getCurrentTime() + gait.duration);
  ...
  gaitSchedule.advanceToTime(gait.eventPhases[0]);
  earlyTouchDownGaitAdaptor = earlyTouchDownAdaptation(earlyTouchDownPerLeg);
  gaitSchedule.adaptCurrentGait(earlyTouchDownGaitAdaptor);
