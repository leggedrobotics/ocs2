...
/******************************************************************************************************/
template <size_t JOINT_COORD_SIZE>
void ComKinoDynamicsBase<JOINT_COORD_SIZE>::initializeModel(logic_rules_machine_t& logicRulesMachine,
...
//	std::array<Eigen::Matrix<scalar_t,3,1>,4> o_stanceFeetPosition;
...
//
//		std::array<bool,numContactPoints> contactFlag = modeNumber2StanceLeg(i);
//
//		scalar_t guardSurfaceValue = 1.0;
//		for (size_t j=0; j<numContactPoints; j++) {
//			if (contactFlag[j]==true)
//				guardSurfaceValue -= 1.0/(scalar_t)numContactPoints * expMinusDistanceToGround(j);
//			else
//				guardSurfaceValue -= 1.0/(scalar_t)numContactPoints * expDistanceToGround(j);
//
//			scalar_t temp;
//			if (contactFlag[j]==true)
