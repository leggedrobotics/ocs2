...
class ComKinoOperatingPointsBase : public ocs2::SystemOperatingPoint<12+JOINT_COORD_SIZE, 12+JOINT_COORD_SIZE, SwitchedModelPlannerLogicRules<JOINT_COORD_SIZE>>
{
public:
	 ...
	 * Default constructor
	 */
	ComKinoOperatingPointsBase(const kinematic_model_t& kinematicModel, const com_model_t& comModel,
	 ...
	 * Default destructor.
	 */
	virtual ~ComKinoOperatingPointsBase()
	{}
	 ...
	 */
	virtual ComKinoOperatingPointsBase<JOINT_COORD_SIZE>* clone() const override;
	 ...
	 */
	void computeOperatingPoints(const generalized_coordinate_t& defaultConfiguration,
