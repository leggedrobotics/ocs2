...
void FeetPlannerBase<scalar_t, cpg_t>::getStartTimesIndices(
		std::array<int_array_t,4>& startTimesIndices) const {
...
/******************************************************************************************************/
template <typename scalar_t, class cpg_t>
void FeetPlannerBase<scalar_t, cpg_t>::getFinalTimesIndices(
		std::array<int_array_t,4>& finalTimesIndices) const {
...
/******************************************************************************************************/
template <typename scalar_t, class cpg_t>
void FeetPlannerBase<scalar_t, cpg_t>::updateFootSchedule(
...
/******************************************************************************************************/
template <typename scalar_t, class cpg_t>
void FeetPlannerBase<scalar_t, cpg_t>::extractContactFlags(
		const size_array_t& phaseIDsStock,
	...
	for (size_t j=0; j<4; j++)
		contactFlagStock[j].resize(numPhases);
...
/******************************************************************************************************/
template <typename scalar_t, class cpg_t>
void FeetPlannerBase<scalar_t, cpg_t>::findIndex (
		const size_t& index,
		const bool_array_t& contactFlagStock,
		int& startTimesIndex,
