#ifndef IIT_ROBOT_BEAR_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_BEAR_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot bear.
 *
...
public:
    ...
    typedef iit::bear::tpl::MotionTransforms<TRAIT> MTransforms;
...
public:
     ...
     *     the robot bear, which will be used by this instance
