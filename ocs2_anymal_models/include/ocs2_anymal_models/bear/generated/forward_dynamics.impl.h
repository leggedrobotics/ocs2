...
const typename iit::bear::dyn::tpl::ForwardDynamics<TRAIT>::ExtForces
    iit::bear::dyn::tpl::ForwardDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::bear::dyn::tpl::ForwardDynamics<TRAIT>::ForwardDynamics(iit::bear::dyn::tpl::InertiaProperties<TRAIT>& inertia, MTransforms& transforms) :
...
template <typename TRAIT>
void iit::bear::dyn::tpl::ForwardDynamics<TRAIT>::fd(
    JointState& qdd,
    Acceleration& base_a,
