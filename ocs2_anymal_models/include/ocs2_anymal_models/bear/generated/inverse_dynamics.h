#ifndef IIT_BEAR_INVERSE_DYNAMICS_H_
#define IIT_BEAR_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot bear.
 *
...
public:
    ...
    typedef iit::bear::tpl::JointState<Scalar> JointState;
