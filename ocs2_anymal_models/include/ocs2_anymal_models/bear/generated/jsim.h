#ifndef IIT_BEAR_JSIM_H_
#define IIT_BEAR_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot bear.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::bear::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::bear::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::bear::tpl::JointState<Scalar> JointState;
        ...
        typedef iit::bear::tpl::ForceTransforms<TRAIT> FTransforms;
