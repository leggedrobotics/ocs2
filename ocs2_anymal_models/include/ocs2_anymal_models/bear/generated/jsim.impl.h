...
iit::bear::dyn::tpl::JSIM<TRAIT>::JSIM(IProperties& inertiaProperties, FTransforms& forceTransforms) :
...
template <typename TRAIT>
const typename iit::bear::dyn::tpl::JSIM<TRAIT>& iit::bear::dyn::tpl::JSIM<TRAIT>::update(const JointState& state) {
...
template <typename TRAIT>
void iit::bear::dyn::tpl::JSIM<TRAIT>::computeL() {
...
template <typename TRAIT>
void iit::bear::dyn::tpl::JSIM<TRAIT>::computeInverse() {
    computeLInverse();
...
template <typename TRAIT>
void iit::bear::dyn::tpl::JSIM<TRAIT>::computeLInverse() {
