#ifndef IIT_ROBOT_CERBERUS_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_CERBERUS_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot cerberus.
 *
...
public:
    ...
    typedef iit::cerberus::tpl::MotionTransforms<TRAIT> MTransforms;
...
public:
     ...
     *     the robot cerberus, which will be used by this instance
