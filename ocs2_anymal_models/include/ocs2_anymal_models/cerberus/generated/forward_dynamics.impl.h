...
const typename iit::cerberus::dyn::tpl::ForwardDynamics<TRAIT>::ExtForces
    iit::cerberus::dyn::tpl::ForwardDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::cerberus::dyn::tpl::ForwardDynamics<TRAIT>::ForwardDynamics(iit::cerberus::dyn::tpl::InertiaProperties<TRAIT>& inertia, MTransforms& transforms) :
...
template <typename TRAIT>
void iit::cerberus::dyn::tpl::ForwardDynamics<TRAIT>::fd(
    JointState& qdd,
    Acceleration& base_a,
