#ifndef IIT_CERBERUS_INVERSE_DYNAMICS_H_
#define IIT_CERBERUS_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot cerberus.
 *
...
public:
    ...
    typedef iit::cerberus::tpl::JointState<Scalar> JointState;
