...
iit::cerberus::tpl::Jacobians<TRAIT>::Jacobians
    ()
     : 
...
template <typename TRAIT>
void iit::cerberus::tpl::Jacobians<TRAIT>::updateParameters() {
}


template <typename TRAIT>
iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_LF_FOOT::Type_fr_base_J_fr_LF_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
    (*this)(0,2) = 0;
...
template <typename TRAIT>
const typename iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_LF_FOOT& iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_LF_FOOT::update(const JState& jState) {
    Scalar s_q_LF_HAA_;
    Scalar s_q_LF_HFE_;
    Scalar s_q_LF_KFE_;
    Scalar c_q_LF_HAA_;
...
template <typename TRAIT>
iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_LH_FOOT::Type_fr_base_J_fr_LH_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
    (*this)(0,2) = 0;
...
template <typename TRAIT>
const typename iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_LH_FOOT& iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_LH_FOOT::update(const JState& jState) {
    Scalar s_q_LH_HAA_;
    Scalar s_q_LH_HFE_;
    Scalar s_q_LH_KFE_;
    Scalar c_q_LH_HAA_;
...
template <typename TRAIT>
iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_RF_FOOT::Type_fr_base_J_fr_RF_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
    (*this)(0,2) = 0;
...
template <typename TRAIT>
const typename iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_RF_FOOT& iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_RF_FOOT::update(const JState& jState) {
    Scalar s_q_RF_HAA_;
    Scalar s_q_RF_HFE_;
    Scalar s_q_RF_KFE_;
    Scalar c_q_RF_HAA_;
...
template <typename TRAIT>
iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_RH_FOOT::Type_fr_base_J_fr_RH_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
    (*this)(0,2) = 0;
...
template <typename TRAIT>
const typename iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_RH_FOOT& iit::cerberus::tpl::Jacobians<TRAIT>::Type_fr_base_J_fr_RH_FOOT::update(const JState& jState) {
    Scalar s_q_RH_HAA_;
    Scalar s_q_RH_HFE_;
    Scalar s_q_RH_KFE_;
    Scalar c_q_RH_HAA_;
