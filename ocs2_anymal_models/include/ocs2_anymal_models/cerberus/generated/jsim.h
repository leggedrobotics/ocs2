#ifndef IIT_CERBERUS_JSIM_H_
#define IIT_CERBERUS_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot cerberus.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::cerberus::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::cerberus::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::cerberus::tpl::JointState<Scalar> JointState;
        ...
        typedef iit::cerberus::tpl::ForceTransforms<TRAIT> FTransforms;
