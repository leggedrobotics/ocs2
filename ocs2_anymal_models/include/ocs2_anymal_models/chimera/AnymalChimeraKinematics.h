...
class AnymalChimeraKinematics final : public switched_model::KinematicsModelBase<SCALAR_T> {
 public:
  ...
  AnymalChimeraKinematics() = default;

  ~AnymalChimeraKinematics() = default;

  AnymalChimeraKinematics<SCALAR_T>* clone() const override;
...
using AnymalChimeraKinematics = tpl::AnymalChimeraKinematics<ocs2::scalar_t>;
using AnymalChimeraKinematicsAd = tpl::AnymalChimeraKinematics<ocs2::ad_scalar_t>;
 ...
 */
extern template class anymal::tpl::AnymalChimeraKinematics<ocs2::scalar_t>;
extern template class anymal::tpl::AnymalChimeraKinematics<ocs2::ad_scalar_t>;
