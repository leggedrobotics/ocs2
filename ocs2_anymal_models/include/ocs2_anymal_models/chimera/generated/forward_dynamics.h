#ifndef IIT_ROBOT_CHIMERA_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_CHIMERA_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot chimera.
 *
...
public:
    ...
    typedef iit::chimera::tpl::MotionTransforms<TRAIT> MTransforms;
...
public:
     ...
     *     the robot chimera, which will be used by this instance
