...
const typename iit::chimera::dyn::tpl::ForwardDynamics<TRAIT>::ExtForces
    iit::chimera::dyn::tpl::ForwardDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::chimera::dyn::tpl::ForwardDynamics<TRAIT>::ForwardDynamics(iit::chimera::dyn::tpl::InertiaProperties<TRAIT>& inertia, MTransforms& transforms) :
...
template <typename TRAIT>
void iit::chimera::dyn::tpl::ForwardDynamics<TRAIT>::fd(
    JointState& qdd,
    Acceleration& base_a,
