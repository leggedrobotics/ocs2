#ifndef IIT_CHIMERA_INVERSE_DYNAMICS_H_
#define IIT_CHIMERA_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot chimera.
 *
...
public:
    ...
    typedef iit::chimera::tpl::JointState<Scalar> JointState;
