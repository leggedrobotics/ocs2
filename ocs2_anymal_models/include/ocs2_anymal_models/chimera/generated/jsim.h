#ifndef IIT_CHIMERA_JSIM_H_
#define IIT_CHIMERA_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot chimera.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::chimera::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::chimera::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::chimera::tpl::JointState<Scalar> JointState;
        ...
        typedef iit::chimera::tpl::ForceTransforms<TRAIT> FTransforms;
