...
iit::chimera::dyn::tpl::JSIM<TRAIT>::JSIM(IProperties& inertiaProperties, FTransforms& forceTransforms) :
...
template <typename TRAIT>
const typename iit::chimera::dyn::tpl::JSIM<TRAIT>& iit::chimera::dyn::tpl::JSIM<TRAIT>::update(const JointState& state) {
...
template <typename TRAIT>
void iit::chimera::dyn::tpl::JSIM<TRAIT>::computeL() {
...
template <typename TRAIT>
void iit::chimera::dyn::tpl::JSIM<TRAIT>::computeInverse() {
    computeLInverse();
...
template <typename TRAIT>
void iit::chimera::dyn::tpl::JSIM<TRAIT>::computeLInverse() {
