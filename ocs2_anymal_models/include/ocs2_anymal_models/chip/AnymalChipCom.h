...
class AnymalChipCom : public switched_model::ComModelBase<SCALAR_T> {
 public:
   ...
   * Default destructor
   */
  ~AnymalChipCom() = default;

  AnymalChipCom<SCALAR_T>* clone() const override;
...
using AnymalChipCom = tpl::AnymalChipCom<ocs2::scalar_t>;
using AnymalChipComAd = tpl::AnymalChipCom<ocs2::ad_scalar_t>;
 ...
 */
extern template class anymal::tpl::AnymalChipCom<ocs2::scalar_t>;
extern template class anymal::tpl::AnymalChipCom<ocs2::ad_scalar_t>;
