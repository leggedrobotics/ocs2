...
class AnymalChipKinematics final : public switched_model::KinematicsModelBase<SCALAR_T> {
 public:
  ...
  AnymalChipKinematics() = default;

  ~AnymalChipKinematics() = default;

  AnymalChipKinematics<SCALAR_T>* clone() const override;
...
using AnymalChipKinematics = tpl::AnymalChipKinematics<ocs2::scalar_t>;
using AnymalChipKinematicsAd = tpl::AnymalChipKinematics<ocs2::ad_scalar_t>;
 ...
 */
extern template class anymal::tpl::AnymalChipKinematics<ocs2::scalar_t>;
extern template class anymal::tpl::AnymalChipKinematics<ocs2::ad_scalar_t>;
