#ifndef IIT_ROBOT_CROC_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_CROC_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot chip.
 *
...
public:
    ...
    typedef iit::chip::tpl::MotionTransforms<TRAIT> MTransforms;
...
public:
     ...
     *     the robot chip, which will be used by this instance
