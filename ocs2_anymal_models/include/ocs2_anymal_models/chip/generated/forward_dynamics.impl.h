...
const typename iit::chip::dyn::tpl::ForwardDynamics<TRAIT>::ExtForces
    iit::chip::dyn::tpl::ForwardDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::chip::dyn::tpl::ForwardDynamics<TRAIT>::ForwardDynamics(iit::chip::dyn::tpl::InertiaProperties<TRAIT>& inertia, MTransforms& transforms) :
...
template <typename TRAIT>
void iit::chip::dyn::tpl::ForwardDynamics<TRAIT>::fd(
    JointState& qdd,
    Acceleration& base_a,
