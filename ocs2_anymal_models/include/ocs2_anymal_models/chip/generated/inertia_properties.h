#ifndef IIT_ROBOT_CROC_INERTIA_PROPERTIES_H_
#define IIT_ROBOT_CROC_INERTIA_PROPERTIES_H_
...
inline typename InertiaProperties<TRAIT>::Scalar InertiaProperties<TRAIT>::getTotalMass() const {
    return Scalar(25.601385 + 1.8623549 + 2.3501198 + 0.5264926 + 1.8623549 + 2.3501198 + 0.5264926 + 1.8623549 + 2.3501198 + 0.5264926 + 1.8623549 + 2.3501198 + 0.5264926);
}
