#ifndef IIT_CROC_INVERSE_DYNAMICS_H_
#define IIT_CROC_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot chip.
 *
...
public:
    ...
    typedef iit::chip::tpl::JointState<Scalar> JointState;
