...
const typename iit::chip::dyn::tpl::InverseDynamics<TRAIT>::ExtForces
iit::chip::dyn::tpl::InverseDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::chip::dyn::tpl::InverseDynamics<TRAIT>::InverseDynamics(IProperties& inertia, MTransforms& transforms) :
        ...
        RH_SHANK_Ic(RH_SHANK_I)
{
    ...
    std::cout << "Robot chip, InverseDynamics<TRAIT>::InverseDynamics()" << std::endl;
...
template <typename TRAIT>
void iit::chip::dyn::tpl::InverseDynamics<TRAIT>::id(
...
template <typename TRAIT>
void iit::chip::dyn::tpl::InverseDynamics<TRAIT>::G_terms_fully_actuated(
...
template <typename TRAIT>
void iit::chip::dyn::tpl::InverseDynamics<TRAIT>::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
template <typename TRAIT>
void iit::chip::dyn::tpl::InverseDynamics<TRAIT>::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
...
template <typename TRAIT>
void iit::chip::dyn::tpl::InverseDynamics<TRAIT>::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'RH_SHANK'
