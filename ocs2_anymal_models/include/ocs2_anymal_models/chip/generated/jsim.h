#ifndef IIT_CROC_JSIM_H_
#define IIT_CROC_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot chip.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::chip::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::chip::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::chip::tpl::JointState<Scalar> JointState;
        ...
        typedef iit::chip::tpl::ForceTransforms<TRAIT> FTransforms;
