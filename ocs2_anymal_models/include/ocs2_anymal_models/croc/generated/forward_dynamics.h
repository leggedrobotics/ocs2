...
/**
 * The Forward Dynamics routine for the robot croc.
 *
...
public:
    ...
    typedef iit::croc::tpl::MotionTransforms<TRAIT> MTransforms;
...
public:
     ...
     *     the robot croc, which will be used by this instance
