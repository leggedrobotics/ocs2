...
const typename iit::croc::dyn::tpl::ForwardDynamics<TRAIT>::ExtForces
    iit::croc::dyn::tpl::ForwardDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::croc::dyn::tpl::ForwardDynamics<TRAIT>::ForwardDynamics(iit::croc::dyn::tpl::InertiaProperties<TRAIT>& inertia, MTransforms& transforms) :
...
template <typename TRAIT>
void iit::croc::dyn::tpl::ForwardDynamics<TRAIT>::fd(
    JointState& qdd,
    Acceleration& base_a,
