...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot croc.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::croc::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::croc::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::croc::tpl::JointState<Scalar> JointState;
        ...
        typedef iit::croc::tpl::ForceTransforms<TRAIT> FTransforms;
