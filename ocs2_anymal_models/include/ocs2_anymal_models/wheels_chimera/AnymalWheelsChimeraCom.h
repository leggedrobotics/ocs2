...
class AnymalWheelsChimeraCom : public switched_model::ComModelBase<SCALAR_T> {
 public:
   ...
   */
  AnymalWheelsChimeraCom();

  /**
   * Default destructor
   */
  ~AnymalWheelsChimeraCom() = default;

  AnymalWheelsChimeraCom<SCALAR_T>* clone() const override;
...
using AnymalWheelsChimeraCom = tpl::AnymalWheelsChimeraCom<ocs2::scalar_t>;
using AnymalWheelsChimeraComAd = tpl::AnymalWheelsChimeraCom<ocs2::ad_scalar_t>;
 ...
 */
extern template class anymal::tpl::AnymalWheelsChimeraCom<ocs2::scalar_t>;
extern template class anymal::tpl::AnymalWheelsChimeraCom<ocs2::ad_scalar_t>;
