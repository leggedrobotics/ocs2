    ...
    const ExtForces& fext)
{
    ...
    LF_WHEEL_L_v = ((xm->fr_LF_WHEEL_L_X_fr_LF_SHANK) * LF_SHANK_v);
    LF_WHEEL_L_v(iit::rbd::AZ) += qd(LF_WHEEL);
    
    iit::rbd::motionCrossProductMx<Scalar>(LF_WHEEL_L_v, vcross);
    
    LF_WHEEL_L_a = (xm->fr_LF_WHEEL_L_X_fr_LF_SHANK) * LF_SHANK_a + vcross.col(iit::rbd::AZ) * qd(LF_WHEEL);
    ...
    RF_WHEEL_L_v = ((xm->fr_RF_WHEEL_L_X_fr_RF_SHANK) * RF_SHANK_v);
    RF_WHEEL_L_v(iit::rbd::AZ) += qd(RF_WHEEL);
    
    iit::rbd::motionCrossProductMx<Scalar>(RF_WHEEL_L_v, vcross);
    
    RF_WHEEL_L_a = (xm->fr_RF_WHEEL_L_X_fr_RF_SHANK) * RF_SHANK_a + vcross.col(iit::rbd::AZ) * qd(RF_WHEEL);
    ...
    LH_WHEEL_L_v = ((xm->fr_LH_WHEEL_L_X_fr_LH_SHANK) * LH_SHANK_v);
    LH_WHEEL_L_v(iit::rbd::AZ) += qd(LH_WHEEL);
    
    iit::rbd::motionCrossProductMx<Scalar>(LH_WHEEL_L_v, vcross);
    
    LH_WHEEL_L_a = (xm->fr_LH_WHEEL_L_X_fr_LH_SHANK) * LH_SHANK_a + vcross.col(iit::rbd::AZ) * qd(LH_WHEEL);
    ...
    RH_WHEEL_L_v = ((xm->fr_RH_WHEEL_L_X_fr_RH_SHANK) * RH_SHANK_v);
    RH_WHEEL_L_v(iit::rbd::AZ) += qd(RH_WHEEL);
    
    iit::rbd::motionCrossProductMx<Scalar>(RH_WHEEL_L_v, vcross);
    
    RH_WHEEL_L_a = (xm->fr_RH_WHEEL_L_X_fr_RH_SHANK) * RH_SHANK_a + vcross.col(iit::rbd::AZ) * qd(RH_WHEEL);
    ...
    RH_SHANK_Ic = RH_SHANK_Ic + (xm->fr_RH_WHEEL_L_X_fr_RH_SHANK).transpose() * RH_WHEEL_L_Ic * (xm->fr_RH_WHEEL_L_X_fr_RH_SHANK);
    RH_SHANK_f = RH_SHANK_f + (xm->fr_RH_WHEEL_L_X_fr_RH_SHANK).transpose() * RH_WHEEL_L_f;
    ...
    LH_SHANK_Ic = LH_SHANK_Ic + (xm->fr_LH_WHEEL_L_X_fr_LH_SHANK).transpose() * LH_WHEEL_L_Ic * (xm->fr_LH_WHEEL_L_X_fr_LH_SHANK);
    LH_SHANK_f = LH_SHANK_f + (xm->fr_LH_WHEEL_L_X_fr_LH_SHANK).transpose() * LH_WHEEL_L_f;
    ...
    RF_SHANK_Ic = RF_SHANK_Ic + (xm->fr_RF_WHEEL_L_X_fr_RF_SHANK).transpose() * RF_WHEEL_L_Ic * (xm->fr_RF_WHEEL_L_X_fr_RF_SHANK);
    RF_SHANK_f = RF_SHANK_f + (xm->fr_RF_WHEEL_L_X_fr_RF_SHANK).transpose() * RF_WHEEL_L_f;
    ...
    LF_SHANK_Ic = LF_SHANK_Ic + (xm->fr_LF_WHEEL_L_X_fr_LF_SHANK).transpose() * LF_WHEEL_L_Ic * (xm->fr_LF_WHEEL_L_X_fr_LF_SHANK);
    LF_SHANK_f = LF_SHANK_f + (xm->fr_LF_WHEEL_L_X_fr_LF_SHANK).transpose() * LF_WHEEL_L_f;
    ...
    LF_WHEEL_L_a = xm->fr_LF_WHEEL_L_X_fr_LF_SHANK * LF_SHANK_a;
    ...
    RF_WHEEL_L_a = xm->fr_RF_WHEEL_L_X_fr_RF_SHANK * RF_SHANK_a;
    ...
    LH_WHEEL_L_a = xm->fr_LH_WHEEL_L_X_fr_LH_SHANK * LH_SHANK_a;
    ...
    RH_WHEEL_L_a = xm->fr_RH_WHEEL_L_X_fr_RH_SHANK * RH_SHANK_a;
...
void iit::wheels::dyn::tpl::InverseDynamics<TRAIT>::secondPass_fullyActuated(JointState& jForces)
{
    ...
    RH_SHANK_f += xm->fr_RH_WHEEL_L_X_fr_RH_SHANK.transpose() * RH_WHEEL_L_f;
    // Link 'RH_SHANK'
    ...
    LH_SHANK_f += xm->fr_LH_WHEEL_L_X_fr_LH_SHANK.transpose() * LH_WHEEL_L_f;
    // Link 'LH_SHANK'
    ...
    RF_SHANK_f += xm->fr_RF_WHEEL_L_X_fr_RF_SHANK.transpose() * RF_WHEEL_L_f;
    // Link 'RF_SHANK'
    ...
    LF_SHANK_f += xm->fr_LF_WHEEL_L_X_fr_LF_SHANK.transpose() * LF_WHEEL_L_f;
    // Link 'LF_SHANK'
