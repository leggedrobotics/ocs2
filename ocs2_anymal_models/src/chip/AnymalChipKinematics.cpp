...
template <typename SCALAR_T>
switched_model::vector3_s_t<SCALAR_T> AnymalChipKinematics<SCALAR_T>::baseTolegRootInBaseFrame(size_t footIndex) const {
  using trait_t = typename iit::rbd::tpl::TraitSelector<SCALAR_T>::Trait;

  switch (footIndex) {
    case LF: {
      typename iit::chip::tpl::HomogeneousTransforms<trait_t>::Type_fr_base_X_fr_LF_HAA fr_trunk_X_fr_LF_haa_;
      return fr_trunk_X_fr_LF_haa_.template topRightCorner<3, 1>();
    }
    case RF: {
      typename iit::chip::tpl::HomogeneousTransforms<trait_t>::Type_fr_base_X_fr_RF_HAA fr_trunk_X_fr_RF_haa_;
      return fr_trunk_X_fr_RF_haa_.template topRightCorner<3, 1>();
    }
    case LH: {
      typename iit::chip::tpl::HomogeneousTransforms<trait_t>::Type_fr_base_X_fr_LH_HAA fr_trunk_X_fr_LH_haa_;
      return fr_trunk_X_fr_LH_haa_.template topRightCorner<3, 1>();
    }
    case RH: {
      typename iit::chip::tpl::HomogeneousTransforms<trait_t>::Type_fr_base_X_fr_RH_HAA fr_trunk_X_fr_RH_haa_;
