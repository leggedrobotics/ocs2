...
namespace ocs2 {
    ...
    void PenaltyBase<STATE_DIM, INPUT_DIM>::getPenaltyCost(const scalar_array_t &h,
    ...
    template<size_t STATE_DIM, size_t INPUT_DIM>
    void PenaltyBase<STATE_DIM, INPUT_DIM>::getPenaltyCostDerivativeState(
                                                                          const scalar_array_t &h,
    ...
    template<size_t STATE_DIM, size_t INPUT_DIM>
    void PenaltyBase<STATE_DIM, INPUT_DIM>::getPenaltyCostDerivativeInput(const scalar_array_t &h,
    ...
    template<size_t STATE_DIM, size_t INPUT_DIM>
    void PenaltyBase<STATE_DIM, INPUT_DIM>::getPenaltyCostSecondDerivativeState(const scalar_array_t &h,
                                                                                const state_vector_array_t &dhdx,
    ...
    template<size_t STATE_DIM, size_t INPUT_DIM>
    void PenaltyBase<STATE_DIM, INPUT_DIM>::getPenaltyCostSecondDerivativeInput(const scalar_array_t &h,
                                                                                const input_vector_array_t &dhdu,
    ...
    template<size_t STATE_DIM, size_t INPUT_DIM>
    void PenaltyBase<STATE_DIM, INPUT_DIM>::getPenaltyCostDerivativeInputState(const scalar_array_t &h,
                                                                               const state_vector_array_t &dhdx,
                                                                               const input_vector_array_t &dhdu,
    ...
    template<size_t STATE_DIM, size_t INPUT_DIM>
    void PenaltyBase<STATE_DIM, INPUT_DIM>::getConstraintViolationSquaredNorm(const scalar_array_t &h,
