...
class LoopshapingConstraintInputPattern final: public LoopshapingConstraintImplementationBase<FULL_STATE_DIM, FULL_INPUT_DIM,
 ...
 public:
  ...
  LoopshapingConstraintInputPattern( std::shared_ptr<SYSTEM_CONSTRAINT> systemConstraint,
