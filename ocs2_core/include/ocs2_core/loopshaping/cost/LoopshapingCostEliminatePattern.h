//
// Created by rgrandia on 03.05.19.
//
...
class LoopshapingCostEliminatePattern final : public LoopshapingCost<FULL_STATE_DIM, FULL_INPUT_DIM,
 ...
 public:
  ...
  LoopshapingCostEliminatePattern(const SYSTEMCOST &systemCost,
  ...
  LoopshapingCostEliminatePattern* clone() const override {
    return new LoopshapingCostEliminatePattern(*this);
  };
