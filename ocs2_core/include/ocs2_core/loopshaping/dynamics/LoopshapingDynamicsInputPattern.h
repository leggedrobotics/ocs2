...
class LoopshapingDynamicsInputPattern final : public LoopshapingDynamics<FULL_STATE_DIM, FULL_INPUT_DIM,
 ...
 public:
  ...
  LoopshapingDynamicsInputPattern* clone() const override {
      return new LoopshapingDynamicsInputPattern(*this);
  };
