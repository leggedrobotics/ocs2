...
TEST(ocs2_cart_pole_raisim_example, ConversionsConsistency) {
  vector_t ocs2_state;
  ocs2_state.setRandom(STATE_DIM_);

  vector_t ocs2_input;
  ocs2_input.setConstant(INPUT_DIM_, NAN);
...
TEST(ocs2_cart_pole_raisim_example, RolloutTest) {
  ...
  ocs2::RaisimRollout rollout(STATE_DIM_, INPUT_DIM_, ros::package::getPath("ocs2_cart_pole_example") + "/urdf/cartpole.urdf",
