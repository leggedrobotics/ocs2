#ifndef IIT_CAMEL_JSIM_H_
#define IIT_CAMEL_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot camel.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::camel::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::camel::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>> Base;
    public:
        ...
        typedef iit::camel::tpl::ForceTransforms<TRAIT> FTransforms;
