...
class TerrainPlaneVisualizer {
 public:
  ...
  explicit TerrainPlaneVisualizer(const rclcpp::Node::SharedPtr& node);
...
class TerrainPlaneVisualizerSynchronizedModule
    : public ocs2::SolverSynchronizedModule {
 public:
  TerrainPlaneVisualizerSynchronizedModule(
