...
%todo: add the details of the continuous model f 
%todo: currently it is only first order euler equation
\begin{subequations}
	\begin{align}
	x_{k+1} = f(x_k,u_k)
	\end{align}
...
%todo: add more details of the QR decomposition part
%todo: see the reference from Ruben 
\begin{subequations}
	\begin{align}
