...
class MultipleShootingMpc : public MPC_BASE {
 public:
  MultipleShootingMpc(mpc::Settings mpcSettings, std::unique_ptr<MultipleShootingSolver> solverPtr)
      : MPC_BASE(std::move(mpcSettings)), solverPtr_(std::move(solverPtr)) {};
