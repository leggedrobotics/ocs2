...
class DiscreteTranscriptionTest : public testing::Test {
 protected:
  ...
  DiscreteTranscriptionTest() {
    srand(0);
    const auto cost = ocs2::qp_solver::getOcs2Cost(ocs2::qp_solver::getRandomCost(STATE_DIM, INPUT_DIM),
    ...
    const auto system = ocs2::qp_solver::getOcs2Dynamics(ocs2::qp_solver::getRandomDynamics(STATE_DIM, INPUT_DIM));
