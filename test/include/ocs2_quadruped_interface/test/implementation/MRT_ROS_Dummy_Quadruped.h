...
MRT_ROS_Dummy_Quadruped<JOINT_COORD_SIZE, STATE_DIM, INPUT_DIM>::MRT_ROS_Dummy_Quadruped(
    ...
    : BASE(mrt_ptr_t(new mrt_t(ocs2QuadrupedInterfacePtr, robotName)), mrtDesiredFrequency, mpcDesiredFrequency,
           ocs2QuadrupedInterfacePtr->getSystemDynamicsPtr().get(), ocs2QuadrupedInterfacePtr->slqSettings().rolloutSettings_),
...
MRT_ROS_Dummy_Quadruped<JOINT_COORD_SIZE, STATE_DIM, INPUT_DIM>::MRT_ROS_Dummy_Quadruped(
    ...
    : BASE(mrtPtr, mrtDesiredFrequency, mpcDesiredFrequency, ocs2QuadrupedInterfacePtr->getSystemDynamicsPtr().get(),
